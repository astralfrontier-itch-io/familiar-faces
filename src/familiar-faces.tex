...
You can choose from protagonist characters' backstories, goals, or affiliations.
You can also pick an issue that's active in the story.
...
Then, pick another character or a group as a whole.
Next, name a shared responsibility, interest, or other activity.
