...
% TODO: turn this into a defined style
\startalignment[middle]
{\tfxx CC-BY 4.0 by Astral Frontier}
\stopalignment
...
\startitemize[n]
\item Anchor the NPC by choosing a reason for being and a core emotion
\item Create internal and external conflicts for the NPC
\item Interview the NPC
\stopitemize
