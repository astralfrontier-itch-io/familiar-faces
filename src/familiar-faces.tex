...
The resulting sentence is the NPC's {\gameterm anchor}. The NPC's actions and reactions should tie back to this anchor somehow.
...
Finally, name a point of contention within that shared sphere.
